...
# ATTENTION: this is hard coded (assumes that the snout marker is called 'spot_head_003' and the one before that 'spot_head_002')
def initialize_x(args,
    ...
    #
#     target_skeleton_coords = np.copy(skeleton_coords) # to recover scan pose
